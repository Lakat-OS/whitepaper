...
In 2006 the platform Scholarpedia \cite{}\remark{find source} was launched. It is a wiki-based format with a peer review layer. One of the drawback is the need to be affiliated with an institution to be allowed to contribute. The authors of an article are either chosen or elected. This to our mind has two drawbacks. First it raises the question who elects those that elect. Second, the collaborative dimension of wikipedia is lost. In 2007 the Citizendium fork of the english wikipedia launched 

In contrast Lakat is permissionless. No one is barred from editing or from proposing pull requests to change content. 
