...
\STATE downstreamBranches $\leftarrow$ orderedList of branches downstream of targetBranch
  ...
  \ELSE
    \IF {defaultSuccessor(currentBranch) equals childSprout}
      ...
      \ELSE
        ...
        \IF {voting has finished, i.e. engagementTime is over (plus lignificationTime plus broadcastingBuffer)}
