...
\STATE targetBranch.sprouts $\leftarrow$ defaultSprout.sprouts
\IF {mergeSubmit not downstreamOf(defaultSprout.stableHead)}
\STATE checkChildSprouts $\leftarrow$ TRUE
\ELSE
...
\STATE targetBranch.sprouts $\leftarrow$ winningSprout.sprouts
\STATE checkChildSprouts $\leftarrow$ TRUE
\ELSE
\STATE checkChildSprouts $\leftarrow$ FALSE
\ENDIF
